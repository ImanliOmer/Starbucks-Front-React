...
const Menu = () => {
    ...
    return items.map((item) => (
      <a href="#" class="">
        <div className="flex flex-row items-center gap-5 font-semibold">
          ...
          <h3 class="mt-4 text-lg text-gray-700 text-center">{item.name}</h3>
        </div>
      </a>
    ));
  };
  ...
  <div className="w-full">
    ...
    <div className="bg-white m-5">
      ...
      <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 " />
      <div className="mx-auto grid px-4 py-4 lg:max-w-6xl lg:px-8">
        <div className="flex grid grid-cols-1 gap-x-2 gap-y-10 xl:grid-cols-2 xl:gap-x-4">
